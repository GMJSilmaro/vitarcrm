  ...
  const CertificateContent = () => (
    <div className="certificate-container p-4">
      ...
      <div className="section mb-4">
        <h6 className="section-title fw-bold">Customer Information</h6>
        <Row>
          <Col md={6}>
          ...
          <Col md={6}>
            <div className="info-item text-end">
              ...
              <span className="value ms-2">{format(new Date(certificate.calibrationDate), 'dd MMM yyyy')}</span>
            </div>
            <div className="info-item text-end">
              <span className="label">Next Due Date:</span>
              <span className="value ms-2">{format(new Date(certificate.nextDueDate), 'dd MMM yyyy')}</span>
            </div>
          </Col>
        </Row>
      </div>
