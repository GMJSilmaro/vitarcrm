...
const WBCertificateOfCalibration = ({ calibration, instruments }) => {
  const auth = useAuth();
  ...
  useEffect(() => {
    if (
      ...
      updateInstance(
        <CocWeightBalancePDF calibration={calibration} instruments={instruments} calibratedBy={calibrateBy} approvedSignatory={approvedSignatory} /> //prettier-ignore
      );
...
export default WBCertificateOfCalibration;
