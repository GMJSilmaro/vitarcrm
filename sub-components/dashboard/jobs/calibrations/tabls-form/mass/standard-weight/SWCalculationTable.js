...
import { formatScientific, formatToDicimalString } from '@/utils/calibrations/data-formatter';
import {
  sqrt,
  mean,
  sum,
                              ...
                              <Table className='text-center fs-6 align-middle' bordered responsive>
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      {formatToDicimalString(
                                        form.watch(`nominalValues.${pointIndex}`),
                                        5
                                      )}{' '}
                                      g g
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {
                                        form.watch(`massComparatorRefEquipment.${pointIndex}`)
                                          ?.uncertainty
                                      }{' '}
                                      g
                                    </td>
                              ...
                              <Table className='text-center fs-6 align-middle' bordered responsive>
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      {form.watch(`ptKgMn3s.${pointIndex}`)} kg m<sup>-3</sup>
                                    </td>
                                  </tr>
                                  <tr>
                                    <th>
                                    ...
                                    <td>
                                      {form.watch(`uPtKgMn3s.${pointIndex}`)} kg m<sup>-3</sup>
                                    </td>
                                  </tr>
                                  <tr>
                                    <th>
                                    ...
                                    <td>
                                      {formatToDicimalString(form.watch(`densityOfMoistAir`), 4)} kg
                                      m<sup>-3</sup>
                                    </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>{form.watch(`data.${pointIndex}.uP`)} Pa</td>
                                  </tr>
                                  <tr>
                                    <th>
                                      U<sub>t</sub>
                                    </th>
                                    <td>{form.watch(`data.${pointIndex}.uT`)} K</td>
                                  </tr>
                                  <tr>
                                    <th>
                                      U<sub>hr</sub>
                                    </th>
                                    <td>{form.watch(`data.${pointIndex}.uHr`)}</td>
                                  </tr>
                                  <tr>
                                    <th>Corr. Factor for air buoyancy, C</th>
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.corrFactorForAirBuoyancy`),
                                        3
                                      )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(form.watch(`data.${pointIndex}.uB`), 3)} g
                                    </td>
                                  </tr>
                                </tbody>
                              </Table>
                              ...
                              <Table className='text-center fs-6 align-middle' bordered responsive>
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <th>
                                      {formatToDicimalString(
                                        form.watch(`data.${pointIndex}.totalActualWeight`),
                                        6
                                      )}{' '}
                                      g
                                    </th>
                                  ...
                                  <tr>
                                    ...
                                    <th>
                                      {formatToDicimalString(
                                        form.watch(`data.${pointIndex}.averageMci`),
                                        6
                                      )}{' '}
                                      g
                                    </th>
                                  ...
                                  <tr>
                                    ...
                                    <th>
                                      {formatToDicimalString(
                                        form.watch(`data.${pointIndex}.testWeight`),
                                        6
                                      )}{' '}
                                      g
                                    </th>
                                  ...
                                  <tr>
                                    ...
                                    <th>
                                      {formatToDicimalString(
                                        form.watch(`resultExpandedUncertainties.${pointIndex}`),
                                        6
                                      )}{' '}
                                      g
                                    </th>
                              ...
                              <Table className='text-center fs-6 align-middle' bordered responsive>
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      {formatToDicimalString(
                                        form.watch(`data.${pointIndex}.totalUcertg`),
                                        6
                                      )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.totalUcert2g2`),
                                        3
                                      )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.totalUcert4g4`),
                                        3
                                      )}
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {isNominalValueNotZero
                                        ? formatToDicimalString(
                                            form.watch(`data.${pointIndex}.uCertMcr`),
                                            6
                                          )
                                        : ''}
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {isNominalValueNotZero
                                        ? formatScientific(
                                            form.watch(`data.${pointIndex}.uCert4g4Veff`),
                                            3
                                          )
                                        : ''}
                                    </td>
                              ...
                              <Table className='text-center fs-6 align-middle' bordered responsive>
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.totalUinst2g2`),
                                        3
                                      )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.totalUinst4vG4`),
                                        3
                                      )}
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {formatToDicimalString(
                                        form.watch(`data.${pointIndex}.totalDriftg`),
                                        6
                                      )}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      {isNominalValueNotZero
                                        ? formatToDicimalString(
                                            form.watch(`data.${pointIndex}.uInstMcr`),
                                            6
                                          )
                                        : ''}
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {isNominalValueNotZero
                                        ? formatScientific(
                                            form.watch(`data.${pointIndex}.uInst4g4Veff`),
                                            3
                                          )
                                        : ''}
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      {formatScientific(
                                        form.watch(`data.${pointIndex}.totalDriftgDivideSqrtOf3`),
                                        5
                                      )}
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <th>
                                      ...
                                      <span style={{ borderTop: '1px solid black' }}>
                                        <span>(△</span>
                                        <em>m</em>
                                        <sub style={{ textDecoration: 'unset' }}>c</sub>
                                        <span>)</span>
                                      </span>
                                    </th>
                                    <td>
...
const RefTable = ({ testWeightNo, pointIndex, showUncertaintyBudget }) => {
  ...
  const densityOfMoistAir = useWatch({
    control: form.control,
    name: 'densityOfMoistAir',
  });
  ...
  const unitsUsedForCOC = useMemo(() => {
    const result = cData?.map(v => v?.unitUsedForCOC?.value || '') || []; // prettier-ignore

    //* set temporary value
    form.setValue(`unitsUsedForCOC`, result);
  ...
  const conventionalValues = useMemo(() => {
    ...
    return result;
  }, [testWeightNo, JSON.stringify(nominalValues), JSON.stringify(testWeights)]);
  ...
  const mpes = useMemo(() => {
    ...
    const result = Array.from({ length: testWeightNo }).map((_, i) => {
      ...
      const acrRef = acr.data.find((acrRef) => acrRef.code == nominalValue)?.[acClass];
  ...
  const corrFactorForAirBuoyancy = useMemo(() => {
    ...
    return result;
  }, [JSON.stringify(ptKgMn3s), JSON.stringify(firstRefData), pointIndex, densityOfMoistAir]);
  ...
  const uB = useMemo(() => {
    ...
    const b1 = pow(multiply(totalActualWeight, subtract(densityOfMoistAir, 1.2)), 2);
  ...
  const totalUcertg = useMemo(() => {
    ...
    const values = refTableData.data.map((refData) => safeParseFloat(refData?.data?.uCertg));
  ...
  const totalDriftg = useMemo(() => {
    ...
    const values = refTableData.data.map((refData) => safeParseFloat(refData?.data?.driftg));
  ...
  return (
    <>
                ...
                <>
                  {ref && (
                    <tr key={`${refDataIndex}`}>
                      ...
                      <td>
                        {formatToDicimalString(safeParseFloat(ref?.currentYearActualValue), 6)}
                      </td>
                      <td>{ref?.prKgMn3 || ''}</td>
                      <td>{ref?.uPrKgMn3 || ''}</td>
                      <td>{ref?.uCertg || ''}</td>
                      ...
                      <td>{ref?.uInst2g2 || ''}</td>
                      <td>{ref?.uInst4vG4 || ''}</td>
                      <td>{formatToDicimalString(safeParseFloat(ref?.driftg), 6)}</td>
                    </tr>
                  )}
                </>
              );
      ...
      {/* //* Table B */}
      <Table className='mt-5 text-center fs-6 m-0 align-middle' bordered responsive>
        <thead>
          <tr>
            <th>
              <em>I</em>
...
const UncertaintyBudgetTable = ({ pointIndex, calculations }) => {
  ...
  const rscmcRefValue = useMemo(() => {
    ...
    const matchRscmc = rscmc.data.find((ref) => ref.nominalValue == nominalValue);
  ...
  const displayResolutionOfComparitorCiUi2 = useMemo(() => {
    ...
    return pow(multiply(displayResolutionOfComparitorUi, displayResolutionOfComparitorCi), 2);
  }, [nominalValue, displayResolutionOfComparitorUi]);

  const displayResolutionOfComparitorCiUi4v = useMemo(() => {
    const displayResolutionOfComparitorCi = COMMON_CI_VALUE;

    const x = multiply(displayResolutionOfComparitorUi, displayResolutionOfComparitorCi);
    const y = pow(x, 4);
    return divide(y, commonValueV);
  ...
  const findClosestDOF = useCallback(
    (value) => {
      ...
      // * sort ck data by DOF
      const sortedCK = [...ck.data].sort((a, b) => safeParseFloat(a.dof) - safeParseFloat(b.dof));
    ...
    <Table className='text-center fs-6 m-0 align-middle' bordered responsive>
      ...
      <tbody>
        <tr>
          ...
          <td className='fw-bold'>{formatScientific(weighingProcessCiUi2, 3)}</td>
          <td className='fw-bold'>{formatScientific(weighingProcessCiUi4v, 3)}</td>
        </tr>
        ...
        <tr>
          ...
          <td>{COMMON_CI_VALUE}</td>
          <td className='fw-bold'>{formatScientific(referenceWeightCiUi2, 3)}</td>
          <td className='fw-bold'>{formatScientific(referenceWeightCiUi4v, 3)}</td>
        </tr>
        ...
        <tr>
          ...
          <td className='text-start'>&nbsp;&nbsp;&nbsp;&nbsp;Calibration Certificate</td>
          <td>gram</td>
          <td>Normal</td>
          <td>B</td>
          <td></td>
        ...
        <tr>
          ...
          <td className='text-start'>&nbsp;&nbsp;&nbsp;&nbsp;Instability / Drift</td>
          <td>gram</td>
          <td>Rect.</td>
          <td>B</td>
          <td></td>
        ...
        <tr>
          ...
          <td>{nominalValue === 0 ? '' : COMMON_CI_VALUE}</td>
          <td className='fw-bold'>{formatScientific(airBouyancyCorrectionCiUi2, 3)}</td>
          <td className='fw-bold'>{formatScientific(airBouyancyCorrectionCiUi4v, 3)}</td>
        </tr>
        ...
        <tr>
          ...
          <td>1</td>
          <td className='fw-bold'>{formatScientific(displayResolutionOfComparitorCiUi2, 3)}</td>
          <td className='fw-bold'>{formatScientific(displayResolutionOfComparitorCiUi4v, 3)}</td>
        </tr>
        ...
        <tr>
          ...
          <td className='fw-bold fs-5' colSpan={4}>
            <span className='me-2'>± {formatToDicimalString(combineUncertainty, 6)} gram</span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className='fw-bold fs-5' colSpan={4}>
            <span className='me-2'>±{formatScientific(effectiveNumberDegressOfFreedom, 3)}</span>
          </td>
        </tr>
