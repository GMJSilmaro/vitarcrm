...
import {
  NOMINAL_VALUE,
  NOMINAL_VALUE_MULTIPLIER,
  TAG_ID_BY_CLASS_MAP,
} from '@/schema/calibrations/mass/weight-balance';

const WBDFNVTest = ({ data, rangeIndex }) => {
  ...
  useEffect(() => {
    //* if data exist and calibration point no is same as data's dont do something, else set initial data
