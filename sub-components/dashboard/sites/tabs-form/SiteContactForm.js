...
const SiteContactForm = ({ data, isLoading, handleNext }) => {
    ...
    <>
      ...
      {fields.length === 0 && (
        <div className='text-center py-5'>
          ...
          <p className='text-muted'>Click "Add Additional Contact" to begin.</p>
        </div>
      )}
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <>
                                      ...
                                      {formErrors && formErrors.contacts?.[i]?.email?.message && (
                                        <Form.Text className='text-danger'>
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <>
                                      ...
                                      {formErrors && formErrors.contacts?.[i]?.phone?.message && (
                                        <Form.Text className='text-danger'>
