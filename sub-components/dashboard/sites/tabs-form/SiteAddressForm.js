...
const SiteAddressForm = ({ data, isLoading, handleNext }) => {
        ...
        <div className='d-flex justify-content-between align-items-center mb-3'>
          <div>
            ...
            {formErrors && formErrors.addresses?.message && (
              <Form.Text className='text-danger mt-0'>{formErrors.addresses?.message}</Form.Text>
            )}
          </div>
                ...
                <Col md={4}>
                  <Form.Group className='mb-3'>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <>
                          <Form.Control {...field} id='City' type='text' placeholder='Enter city' />
                      ...
                      render={({ field }) => (
                        <>
                          <Select
                            ...
                            isDisabled={countriesOptions.isLoading || countriesOptions.length < 1}
                            noOptionsMessage={() =>
