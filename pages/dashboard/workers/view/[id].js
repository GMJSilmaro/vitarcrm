...
import { Calendar2, CheckCircle, XCircle, Upload } from 'react-bootstrap-icons';
...
const WorkerDetails = () => {
  ...
  const [schedules, setSchedules] = useState({
    monday: {
      firstShift: { start: '8:00 AM', end: '6:00 PM' },
      secondShift: { start: '', end: '' },
    },
    tuesday: {
      firstShift: { start: '8:00 AM', end: '6:00 PM' },
      secondShift: { start: '', end: '' },
      ...
      <Modal.Body>
          ...
          <Col md={6}>
            <Form.Group className='mb-3'>
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setNewCertificate((prev) => ({ ...prev, issueDate: e.target.value }))
                }
              />
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group className='mb-3'>
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setNewCertificate((prev) => ({ ...prev, expiryDate: e.target.value }))
                }
              />
            </Form.Group>
          </Col>
        ...
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) =>
              setNewCertificate((prev) => ({ ...prev, certificateId: e.target.value }))
            }
  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Badge bg={getStatusColor(row.original.jobStatus)}>{row.original.jobStatus}</Badge>
        ),
      },
      {
        header: 'Priority',
        ...
        cell: ({ row }) =>
          row.original.priority && (
            <Badge bg={getPriorityColor(row.original.priority)}>{row.original.priority}</Badge>
          ),
      },
      {
        header: 'Schedule',
  ...
  return (
    <div className='container-fluid px-4'>
      {/* Header Section */}
      <ContentHeader
        title={`View Details for ${worker.fullName}`}
        description='View comprehensive worker details including personal info, certifications, assignments and performance history'
            ...
            <div className='position-relative'>
              ...
              <span
                className={`position-absolute bottom-0 end-0 ${
                  worker.isOnline ? 'bg-success' : 'bg-secondary'
                }`}
                style={{
                  width: '20px',
                  height: '20px',
                  ...
                  <Card.Header className='bg-transparent border-0 pt-4 pb-0'>
                    <div className='d-flex justify-content-between align-items-center'>
                      <div>
                        ...
                        <small className='text-muted'>
                          Basic worker details and contact information
                        </small>
                      </div>
                      <Badge
                          ...
                          <div className='info-card'>
                            ...
                            <div className='info-content'>
                              ...
                              <div className='info-value'>
                                {format(new Date(worker.dateOfBirth), 'MMMM d, yyyy')}
                              </div>
                            </div>
                          </div>
                          <div className='info-card'>
                            ...
                            <div className='info-content'>
                              ...
                              <div className='info-value'>
                                ...
                                <div className='address-secondary'>
                                  {[worker.stateProvince, worker.zipCode]
                                    .filter(Boolean)
                                    .join(', ')}
                                </div>
                              </div>
                ...
                <Card className='border-0 shadow-sm mb-4'>
                  ...
                  <Card.Body>
                    <div className='status-item mb-4'>
                      ...
                      <Badge bg={worker.isActive ? 'success' : 'danger'} className='status-badge'>
                        {worker.isActive ? 'Active' : 'Inactive'}
                      </Badge>
                    </div>
                    ...
                    <div className='status-item'>
                      ...
                      <div className='d-flex align-items-center'>
                        <div
                          className={`status-indicator ${worker.isOnline ? 'online' : 'offline'}`}
                        ></div>
                        <div>
                  ...
                  <Card.Body>
                    <div className='skills-grid'>
                      {worker.skills?.map((skill, index) => (
                        <Badge key={index} className='skill-badge' bg='light' text='dark'>
                  ...
                  <Card.Header className='bg-transparent border-0 pt-4 pb-0'>
                    <div className='d-flex justify-content-between align-items-center'>
                      <div>
                        ...
                        <small className='text-muted'>
                          Manage worker's professional skills and competencies
                        </small>
                      </div>
                      <Badge
                        className='profile-badge'
                        ...
                        <div className='shift-group'>
                          ...
                          <div className='d-flex gap-2'>
                            <Form.Select
                              ...
                              onChange={(e) =>
                                handleScheduleChange(day, 'firstShift', 'start', e.target.value)
                              }
                            >
                            ...
                            <Form.Select
                              ...
                              onChange={(e) =>
                                handleScheduleChange(day, 'firstShift', 'end', e.target.value)
                              }
                            >
                              <option value=''>Select time</option>
                        ...
                        <div className='shift-group'>
                          ...
                          <div className='d-flex gap-2'>
                            <Form.Select
                              ...
                              onChange={(e) =>
                                handleScheduleChange(day, 'secondShift', 'start', e.target.value)
                              }
                            >
                              <option value=''>Select time</option>
                              {startTimeOptions.map((time) => (
                            ...
                            <Form.Select
                              ...
                              onChange={(e) =>
                                handleScheduleChange(day, 'secondShift', 'end', e.target.value)
                              }
                            >
                              <option value=''>Select time</option>
                              {endTimeOptions.map((time) => (
                ...
                {documents.length === 0 ? (
                  <div className='text-center py-5'>
                    ...
                    <p className='text-muted'>
                      Upload worker documents like contracts, certificates, or IDs
                    </p>
                  </div>
                ) : (
