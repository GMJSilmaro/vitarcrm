    ...
    <>
      ...
      <ContentHeader
        ...
        breadcrumbItems={[
          ...
          ,
          {
            text: acr ? acr.id : 'Create',
            link: `/calibration-references/mass/acr/edit-acr/${refId}`,
        ...
        dropdownItems={[
          {
            label: 'View ACR',
            icon: Eye,
            onClick: () => router.push(`/calibration-references/mass/acr/view/${refId}`),
          },
        ]}
      />
