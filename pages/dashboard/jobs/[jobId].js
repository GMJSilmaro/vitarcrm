      ...
      <div className={styles.container}>
        <Row>
          <Col lg={12} md={12} sm={12}>
            <ContentHeader
              title={`Job #${job.jobNo}`}
              description="View and manage job details, tasks, and progress"
              badgeText={job.jobType || "Maintenance"}
              badgeText2={getJobStatusName(job.jobStatus)}
              breadcrumbItems={[
                {
                  text: 'Dashboard',
                  link: '/dashboard',
                ...
                {
                  text: 'Job Details',
                  icon: <i className="fe fe-file-text" style={{ marginRight: '8px' }} />
                }
              ]}
              actionButton={{
                text: 'Edit Job',
                  ...
                  <div className={styles.customerCard}>
                    ...
                    <div className={styles.cardHeader}>
                      <div className={styles.headerContent}>
                        <div className={styles.companyAvatar}>{job.customerName.charAt(0)}</div>
                        <div>
